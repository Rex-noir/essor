...
class $HabitEntriesTableTable extends HabitEntriesTable
    with TableInfo<$HabitEntriesTableTable, HabitEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  List<GeneratedColumn> get $columns => [id, habitId, entryDate, value];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class HabitEntry extends DataClass implements Insertable<HabitEntry> {
  ...
  HabitEntryCompanion toCompanion(bool nullToAbsent) {
  ...
  HabitEntry copyWithCompanion(HabitEntryCompanion data) {
    return HabitEntry(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  int get hashCode => Object.hash(id, habitId, entryDate, value);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is HabitEntry &&
...
class HabitEntryCompanion extends UpdateCompanion<HabitEntry> {
  final Value<String> id;
  ...
  @override
  String toString() {
    return (StringBuffer('HabitEntryCompanion(')
          ..write('id: $id, ')
          ..write('habitId: $habitId, ')
          ..write('entryDate: $entryDate, ')
          ..write('value: $value, ')
...
class $NotificationEntriesTableTable extends NotificationEntriesTable
    with TableInfo<$NotificationEntriesTableTable, NotificationEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $NotificationEntriesTableTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  List<GeneratedColumn> get $columns => [modelId, id, notificationId, date];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'notification_entries_table';
  @override
  VerificationContext validateIntegrity(
  ...
  @override
  $NotificationEntriesTableTable createAlias(String alias) {
    return $NotificationEntriesTableTable(attachedDatabase, alias);
  }
}
...
class NotificationEntry extends DataClass
  ...
  NotificationEntryCompanion toCompanion(bool nullToAbsent) {
    return NotificationEntryCompanion(
  ...
  NotificationEntry copyWithCompanion(NotificationEntryCompanion data) {
    return NotificationEntry(
  ...
  @override
  int get hashCode => Object.hash(modelId, id, notificationId, date);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class NotificationEntryCompanion extends UpdateCompanion<NotificationEntry> {
  final Value<String> modelId;
  final Value<int> id;
  final Value<int> notificationId;
  final Value<DateTime> date;
  const NotificationEntryCompanion({
  ...
  NotificationEntryCompanion copyWith({
  ...
  @override
  String toString() {
    return (StringBuffer('NotificationEntryCompanion(')
          ..write('modelId: $modelId, ')
          ..write('id: $id, ')
          ..write('notificationId: $notificationId, ')
          ..write('date: $date')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $NotificationEntriesTableTable notificationEntriesTable =
      $NotificationEntriesTableTable(this);
  @override
...
final class $$HabitsTableTableReferences
  ...
  static MultiTypedResultKey<$HabitEntriesTableTable, List<HabitEntry>>
  _habitEntriesTableRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.habitEntriesTable,
        aliasName: $_aliasNameGenerator(
          db.habitsTable.id,
          db.habitEntriesTable.habitId,
        ),
      );
...
class $$HabitsTableTableTableManager
    extends
        RootTableManager<
          ...
          Habit,
          PrefetchHooks Function({bool habitEntriesTableRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({habitEntriesTableRefs = false}) {
            return PrefetchHooks(
              db: db,
...
final class $$HabitEntriesTableTableReferences
    extends BaseReferences<_$AppDatabase, $HabitEntriesTableTable, HabitEntry> {
  ...
  static $HabitsTableTable _habitIdTable(_$AppDatabase db) =>
      db.habitsTable.createAlias(
        $_aliasNameGenerator(db.habitEntriesTable.habitId, db.habitsTable.id),
      );
...
class $$HabitEntriesTableTableTableManager
    extends
        RootTableManager<
          ...
          (HabitEntry, $$HabitEntriesTableTableReferences),
          HabitEntry,
...
typedef $$HabitEntriesTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool habitId})
    >;
typedef $$NotificationEntriesTableTableCreateCompanionBuilder =
    NotificationEntryCompanion Function({
      required String modelId,
      Value<int> id,
      required int notificationId,
      required DateTime date,
    });
typedef $$NotificationEntriesTableTableUpdateCompanionBuilder =
    NotificationEntryCompanion Function({
      Value<String> modelId,
      Value<int> id,
      Value<int> notificationId,
...
class $$NotificationEntriesTableTableFilterComposer
    extends Composer<_$AppDatabase, $NotificationEntriesTableTable> {
  $$NotificationEntriesTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$NotificationEntriesTableTableOrderingComposer
    extends Composer<_$AppDatabase, $NotificationEntriesTableTable> {
  $$NotificationEntriesTableTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$NotificationEntriesTableTableAnnotationComposer
    extends Composer<_$AppDatabase, $NotificationEntriesTableTable> {
  $$NotificationEntriesTableTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$NotificationEntriesTableTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $NotificationEntriesTableTable,
          NotificationEntry,
          $$NotificationEntriesTableTableFilterComposer,
          $$NotificationEntriesTableTableOrderingComposer,
          $$NotificationEntriesTableTableAnnotationComposer,
          $$NotificationEntriesTableTableCreateCompanionBuilder,
          $$NotificationEntriesTableTableUpdateCompanionBuilder,
          (
            NotificationEntry,
            BaseReferences<
              _$AppDatabase,
        ...
        > {
  $$NotificationEntriesTableTableTableManager(
    _$AppDatabase db,
    $NotificationEntriesTableTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$NotificationEntriesTableTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $NotificationEntriesTableTable,
      NotificationEntry,
...
class $AppDatabaseManager {
  ...
  $$NotificationEntriesTableTableTableManager get notificationEntriesTable =>
      $$NotificationEntriesTableTableTableManager(
        _db,
        _db.notificationEntriesTable,
      );
}
